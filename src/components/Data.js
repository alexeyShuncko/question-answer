export const data = [
  ...
  },
  {
    Q: {
      ...
      `,
      answer: `Веду разработку в VS Code. GitHub использую для удаленного хранения версий и деплоя моих проектов. Панель разработчика в Google Chrome для проверки и отладки кода.`,
    },
  },
  {
    Q: {
